...
{
    public partial class ConsultaRecepcionesTrainer : System.Web.UI.Page
    {
        ...
        private void LlenarCombos()
        {
            ...
            dtCombos = objTrainerBL.ListarTrainer();
            // Creamos un nuevo item de cliente ....
            ...
            cboTrainer.DataSource = dtCombos;
            cboTrainer.DataTextField = "nomApe";
            cboTrainer.DataValueField = "Id_Trainer";
            cboTrainer.DataBind();
        ...
        private void Filtrar(Boolean blnFlag)
        {
            ...
            if (cboTrainer.SelectedValue == "X") // si eligio Todos
            {
                idTrainer = "";
            ...
            {
                idTrainer = cboTrainer.SelectedValue;
            }
            ...
            {
                grvAsistencia.DataSource = objAsistenciaBL.usp_ListarTrainers_Paginacion("", "", "", 0);

            }
            else // caso contrario ya se genero un filtro, por eso se le pasan las variables del filtro al metodo
            {
                grvAsistencia.DataSource = objAsistenciaBL.usp_ListarTrainers_Paginacion(idTrainer, codven, estado, pagina);
            ...
            Int16 intNumReg;
            intNumReg = objAsistenciaBL.usp_NumPag_ListarTrainers_Paginacion(idTrainer, codven, estado);
