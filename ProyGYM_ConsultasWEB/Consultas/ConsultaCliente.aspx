<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaCliente.aspx.cs" Inherits="ProyGYM_ConsultasWEB.Consultas.ConsultaCliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="auto-style1" >
        ...
        <tr>
            <td class="auto-style17">Fecha de inicio:</td>
        ...
        <tr>
            <td class="labelContenido">
                <asp:Button ID="Button1" runat="server" CausesValidation="False" CssClass="boton2" Height="21px" PostBackUrl="~/Rutas.aspx" Text="cancelar" Width="87px" OnClick="Button1_Click" />
            </td>
            <td>
        ...
        <tr>
            <td class="labelContenido" colspan="4">
                <asp:GridView ID="dtgAsistencia" runat="server" Width="1145px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" OnPageIndexChanging="dtgAsistencia_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="Nombre_Recep" HeaderText="Recepcionista" />
